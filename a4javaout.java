...
public class a4javaout implements a4javaoutConstants {
  ...
  static final public StaticMethodDeclaration StaticMethodDeclaration() throws ParseException {
   ...
   Token n24;
    ...
    n24 = jj_consume_token(RBRACE);
     ...
     {if (true) return new StaticMethodDeclaration(n0,n2,n4,n5,n6,n8,n10,n12,n14,n16,n18,n20,n21,n23);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public StoreStatement StoreStatement() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   ...
   Token n9;
    ...
    n9 = jj_consume_token(SEMICOLON);
            n8 = JTBToolkit.makeNodeToken(n9);
     {if (true) return new StoreStatement(n0,n1,n3,n5,n7,n8);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ThisStoreStatement ThisStoreStatement() throws ParseException {
   ThisExpression n0;
   NodeToken n1;
   Token n2;
   Identifier n3;
   ...
   Token n8;
    ...
    n8 = jj_consume_token(SEMICOLON);
            n7 = JTBToolkit.makeNodeToken(n8);
     {if (true) return new ThisStoreStatement(n0,n1,n3,n4,n6,n7);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public TypeCast TypeCast() throws ParseException {
   ...
   Identifier n5;
    ...
    n4 = jj_consume_token(RPAREN);
            n3 = JTBToolkit.makeNodeToken(n4);
    n5 = Identifier();
     {if (true) return new TypeCast(n0,n2,n3,n5);}
    throw new Error("Missing return statement in function");
  }

  static final public LoadStatement LoadStatement() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(DOT);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new LoadStatement(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
